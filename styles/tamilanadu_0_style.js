...
var style_tamilanadu_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("populati_2");
    var labelText = "";
    size = 0;
    ...
    if (value >= 110647.000000 && value <= 147156.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 147156.000000 && value <= 232230.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 232230.000000 && value <= 356721.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 356721.000000 && value <= 425687.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 425687.000000 && value <= 460889.000000) {
            style = [ new ol.style.Style({
